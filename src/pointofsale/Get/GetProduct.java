 ...
 * @author Asus
 */
public class GetProduct extends javax.swing.JFrame {
        Connection c1;
        Statement s1;
        ResultSet r1;
    /**
    ...
    public void LoadProduct(){
         ...
         String[][] datatable = new String[rec][5];
         String[] head = {"ProductID", "Name", "SupplierID", "Price", "PromotionID"};
         int count=0;
         r1.first();  
         datatable[count][0] = r1.getString("p_id");
         datatable[count][1] =r1.getString("p_name");
         datatable[count][2] =r1.getString("sp_id");
         datatable[count][3] =r1.getString("price");
         datatable[count][4] =r1.getString("pm_id");
         count++;
         while (r1.next()){
            datatable[count][0] = r1.getString("p_id");
            datatable[count][1] =r1.getString("p_name");
    ...
    private void jLabel18MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel18MouseClicked
        this.setExtendedState(GetProduct.ICONIFIED);
    ...
    private void Button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button1ActionPerformed
        ...
        String sp_id = Table1.getValueAt(Table1.getSelectedRow(), 2).toString();
        String price = Table1.getValueAt(Table1.getSelectedRow(), 3).toString();
        String pm_id = Table1.getValueAt(Table1.getSelectedRow(), 4).toString();
        AddOrder.Form2.setText(p_id);
        AddOrder.Form3.setText(name);
        AddOrder.Form9.setText(sp_id);
        AddOrder.Form5.setText(price);
        AddOrder.Form7.setText(pm_id);
        try{
          Class.forName("com.mysql.cj.jdbc.Driver");
         c1 = DriverManager.getConnection("jdbc:mysql://localhost/goods","root", "0F3E71E5");
         s1 = c1.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
         ...
         r1.next();
         AddOrder.Form7.setText(r1.getString("discount"));
        }catch(Exception e){         
            Message2 myapp  = new Message2();
            myapp.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GetProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GetProduct().setVisible(true);
            }
        });
    }
