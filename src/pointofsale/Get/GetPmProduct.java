...
import pointofsale.admin.AddPromotion;
 ...
 * @author Asus
 */
public class GetPmProduct extends javax.swing.JFrame {
        Connection c1;
        Statement s1;
        ResultSet r1;
    /**
    ...
    private void jLabel18MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel18MouseClicked
        this.setExtendedState(GetPmProduct.ICONIFIED);
    ...
    private void Button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button1ActionPerformed
        ...
        AddPromotion.Form2.setText(name);
         this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GetPmProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GetPmProduct().setVisible(true);
            }
        });
    }
