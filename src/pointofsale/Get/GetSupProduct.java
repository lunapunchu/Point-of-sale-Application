...
import pointofsale.admin.AddSupOrder;
 ...
 * @author Asus
 */
public class GetSupProduct extends javax.swing.JFrame {
        Connection c1;
        Statement s1;
        ResultSet r1;
    /**
    ...
    public void LoadSupProduct(){
         ...
         String[] head = {"ProductID", "Name", "SupplierID", "Price"};
         int count=0;
         r1.first();  
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Supplier Product");
    ...
    private void jLabel18MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel18MouseClicked
        this.setExtendedState(GetSupProduct.ICONIFIED);
    ...
    private void Button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button1ActionPerformed
        ...
        AddSupOrder.Form2.setText(p_id);
        AddSupOrder.Form3.setText(name);
        AddSupOrder.Form4.setText(sp_id);
        AddSupOrder.Form5.setText(price);
         this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GetSupProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GetSupProduct().setVisible(true);
            }
        });
    }
