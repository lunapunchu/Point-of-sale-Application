...
import pointofsale.menu.AddStock;

/**
 *
 * @author Asus
 */
public class GetProduct2 extends javax.swing.JFrame {
        Connection c1;
        Statement s1;
        ResultSet r1;
    /**
    ...
    private void jLabel18MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel18MouseClicked
        this.setExtendedState(GetProduct2.ICONIFIED);
    ...
    private void Button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button1ActionPerformed
        ...
        AddStock.Form2.setText(p_id);
        AddStock.Form3.setText(name);
        AddStock.Form5.setText(sp_id);
        AddStock.Form6.setText(price);
         this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GetProduct2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GetProduct2().setVisible(true);
            }
        });
    }
