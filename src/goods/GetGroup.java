 ...
 * @author Asus
 */
public class GetGroup extends javax.swing.JFrame {
        Connection c1;
        Statement s1;
        ResultSet r1;
    /**
    ...
    public void LoadGroup(){
         ...
         r1 = s1.executeQuery("Select * from productgroup");
         int rec=0;
         while(r1.next()){
             rec++;
         }        
         ...
         int count=0;
         r1.first();  
         datatable[count][0] = r1.getString("g_id");
         datatable[count][1] =r1.getString("g_name");
         count++;
         while (r1.next()){
             datatable[count][0] = r1.getString("g_id");
             datatable[count][1] =r1.getString("g_name");
    ...
    public void Search(){
        try{
           Class.forName("com.mysql.cj.jdbc.Driver");
            c1 = DriverManager.getConnection("jdbc:mysql://localhost/goods", "root", "0F3E71E5");
            s1 = c1.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            r1 = s1.executeQuery("Select * from productgroup where g_id="+Integer.parseInt(FormSearch.getText()));
           int rec=0;
            while(r1.next()){
                rec++;
            }
    ...
    private void jLabel18MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel18MouseClicked
        this.setExtendedState(GetGroup.ICONIFIED);
    ...
    private void Button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button1ActionPerformed
        String g_id = Table1.getValueAt(Table1.getSelectedRow(), 0).toString();
        AddProduct.Form3.setText(g_id);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GetGroup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
