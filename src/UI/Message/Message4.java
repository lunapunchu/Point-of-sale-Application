 ...
 * @author Asus
 */
public class Message4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Login Succeeded !");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Message4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
