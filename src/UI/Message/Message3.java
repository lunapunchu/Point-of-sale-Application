 ...
 * @author Asus
 */
public class Message3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("You are not an admin !");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Message3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
