 ...
 * @author Asus
 */
public class Message7 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("The product has been added to stock !");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Message7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
