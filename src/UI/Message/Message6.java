 ...
 * @author Asus
 */
public class Message6 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Payment Completed !");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Message6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
